...
<section class="section-hero overlay inner-page bg-image" style="background-image: url(<?= base_url('assets/image/background-home.png') ?>);" id="home-section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1 class="text-white font-weight-bold">Tambah Info tambahan</h1>
                <div class="custom-breadcrumbs">
                    <a href="#"><?= $this->session->userdata('nama_depan') ?></a> <span class="mx-2 slash">/</span>
                    <span class="text-white"><strong>Tambah Info tambahan</strong></span>
                </div>
            </div>
        </div>
    </div>
...
<section class="site-section block__18514" id="next-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <!-- <div class="row mb-4"> -->
                <form class="p-4 p-md-5 border rounded" action="<?= base_url('Pages/save_info_tambahan') ?>" enctype="multipart/form-data" method="post">
                    <h3 class="text-black mb-5 border-bottom pb-2">Form Tambah Informasi</h3>
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="currency-field" value="" data-type="currency" name="gaji_diharapkan" placeholder="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="informasi_lainnya" rows="12"></textarea>
                    </div>
