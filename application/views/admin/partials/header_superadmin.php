        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="nav-label">Employe Menu</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-users"></i><span class="nav-text">Employe</span></a>
                        <ul aria-expanded="false">
                            <li><a href="<?= base_url('Superadmin/employe') ?>">Employe</a></li>
                            <li><a href="<?= base_url('Superadmin/add_employe') ?>">Create Employe</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
