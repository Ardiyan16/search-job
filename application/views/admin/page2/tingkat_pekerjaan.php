        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Tingkat Pekerjaan</h4>
                    <br>
                    <a href="#add" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Tingkat Pekerjaan</a>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Tingkat Pekerjaan</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($tingkat_pekerjaan as $view) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $view->tingkat_kerja ?></td>
                                            <td>
                                                <a href="#edit<?= $view->id ?>" data-toggle="modal" title="Edit" class="badge bg-primary" style="color: white;"><i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('Admin/delete_level_job/' . $view->id) ?>" onclick="return confirm('apakah anda yakin menghapus data ?')" title="Hapus" class="badge bg-danger" style="color: white;"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Tingkat Pekerjaan</h5>
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form action="<?= base_url('Admin/save_level_job') ?>" name="add_tingkat_pekerjaan" method="POST">
                        <div class="form-group">
                            <label>Tingkat Pekerjaan *</label>
                            <input type="text" class="form-control" name="tingkat_kerja" placeholder="">
                        </div>
...
<?php foreach ($edit as $edit) { ?>
    <div class="modal fade" id="edit<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Tingkat Pekerjaan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="basic-form">
                        <form action="<?= base_url('Admin/update_level_job') ?>" method="POST">
                            <div class="form-group">
                                <label>Tingkat Pekerjaan *</label>
                                <input type="hidden" class="form-control" value="<?= $edit->id ?>" name="id" placeholder="">
                                <input type="text" class="form-control" value="<?= $edit->tingkat_kerja ?>" name="tingkat_kerja" placeholder="">
                            </div>
                            <button type="reset" class="btn btn-warning mt-3"><i class="fa fa-refresh"></i> Reset</button>
                            <button type="submit" class="btn btn-primary mt-3"><i class="fa fa-save"></i> Save</button>
                        </form>
...
<script>
    ...
    $(function() {
        ...
        $("form[name='add_tingkat_pekerjaan']").validate({
            ...
            messages: {
                tingkat_kerja: {
                    required: "tingkat pekerjaan is required (tingkat pekerjaan harus di isi)",
                }
            },
