        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Ukuran Perusahaan</h4>
                    <br>
                    <a href="#add" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Ukuran Perusahaan</a>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Menu Tambahan</a></li>
                    <li class="breadcrumb-item"><a href="#">Ukuran Perusahaan</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Ukuran Perusahaan</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($ukuran_perusahaan as $view) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $view->ukuran ?></td>
                                            <td>
                                                <a href="#edit<?= $view->id ?>" data-toggle="modal" title="Edit" class="badge bg-primary" style="color: white;"><i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('Admin/delete_company_size/' . $view->id) ?>" onclick="return confirm('apakah anda yakin menghapus data ?')" title="Hapus" class="badge bg-danger" style="color: white;"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Ukuran Perusahaan</h5>
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form action="<?= base_url('Admin/save_company_size') ?>" name="add_ukuran_perusahaan" method="POST">
                        <div class="form-group">
                            <label>Ukuran Perusahaan *</label>
                            <input type="text" class="form-control" name="ukuran" placeholder="">
                        </div>
...
<?php foreach ($edit as $edit) { ?>
    <div class="modal fade" id="edit<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Ukuran Perusahaan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="basic-form">
                        <form action="<?= base_url('Admin/update_company_size') ?>" method="POST">
                            <div class="form-group">
                                <label>Ukuran Perusahaan *</label>
                                <input type="hidden" class="form-control" value="<?= $edit->id ?>" name="id" placeholder="">
                                <input type="text" class="form-control" value="<?= $edit->ukuran ?>" name="ukuran" placeholder="">
                            </div>
                            <button type="reset" class="btn btn-warning mt-3"><i class="fa fa-refresh"></i> Reset</button>
                            <button type="submit" class="btn btn-primary mt-3"><i class="fa fa-save"></i> Save</button>
                        </form>
...
<script>
    ...
    $(function() {
        ...
        $("form[name='add_ukuran_perusahaan']").validate({
            ...
            messages: {
                ukuran: {
                    required: "ukuran perusahaan is required (ukuran perusahaan harus di isi)",
                }
            },
