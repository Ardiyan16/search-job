        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Bidang Perusahaan</h4>
                    <br>
                    <a href="#add" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Bidang Perusahaan</a>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Menu Tambahan</a></li>
                    <li class="breadcrumb-item"><a href="#">Bidang Perusahaan</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Bidang Perusahaan</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($bidang_perusahaan as $view) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('Admin/delete_bidang_perusahaan/' . $view->id) ?>" onclick="return confirm('apakah anda yakin menghapus data ?')" title="Hapus" class="badge bg-danger" style="color: white;"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Bidang Perusahaan</h5>
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form action="<?= base_url('Admin/save_field_company') ?>" name="add_bidang_perusahaan" method="POST">
                        <div class="form-group">
                            <label>Bidang Perusahaan *</label>
                            <input type="text" class="form-control" name="bidang_perusahaan" placeholder="">
                        </div>
...
<?php foreach ($edit as $edit) { ?>
    <div class="modal fade" id="edit<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Bidang Perusahaan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="basic-form">
                        <form action="<?= base_url('Admin/update_field_company') ?>" method="POST">
                            <div class="form-group">
                                <label>Bidang Perusahaan *</label>
                                <input type="hidden" class="form-control" value="<?= $edit->id ?>" name="id" placeholder="">
                                <input type="text" class="form-control" value="<?= $edit->bidang_perusahaan ?>" name="bidang_perusahaan" placeholder="">
                            </div>
                            <button type="reset" class="btn btn-warning mt-3"><i class="fa fa-refresh"></i> Reset</button>
                            <button type="submit" class="btn btn-primary mt-3"><i class="fa fa-save"></i> Save</button>
                        </form>
...
<script>
    ...
    $(function() {
        ...
        $("form[name='add_bidang_perusahaan']").validate({
            ...
            messages: {
                bidang_perusahaan: {
                    required: "bidang perusahaan is required (bidang perusahaan harus di isi)",
                }
            },
