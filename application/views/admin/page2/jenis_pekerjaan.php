        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    ...
                    <br>
                    <a href="#add" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Jenis Pekerjaan</a>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Menu Tambahan</a></li>
                    <li class="breadcrumb-item"><a href="#">Jenis Pekerjaan</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($jenis_pekerjaan as $view) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $view->jenis_kerja ?></td>
                                            <td>
                                                <a href="#edit<?= $view->id ?>" data-toggle="modal" title="Edit" class="badge bg-primary" style="color: white;"><i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('Admin/delete_type_job/' . $view->id) ?>" onclick="return confirm('apakah anda yakin menghapus data ?')" title="Hapus" class="badge bg-danger" style="color: white;"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form action="<?= base_url('Admin/save_type_job') ?>" name="add_jenis_pekerjaan" method="POST">
                        <div class="form-group">
                            <label>Jenis Pekerjaan *</label>
                            <input type="text" class="form-control" name="jenis_kerja" placeholder="">
                        </div>
    ...
    <div class="modal fade" id="edit<?= $edit->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="basic-form">
                        <form action="<?= base_url('Admin/update_type_job') ?>" method="POST">
                            <div class="form-group">
                                <label>Jenis Pekerjaan *</label>
                                <input type="hidden" class="form-control" value="<?= $edit->id ?>" name="id" placeholder="">
                                <input type="text" class="form-control" value="<?= $edit->jenis_kerja ?>" name="jenis_kerja" placeholder="">
                            </div>
                            <button type="reset" class="btn btn-warning mt-3"><i class="fa fa-refresh"></i> Reset</button>
                            <button type="submit" class="btn btn-primary mt-3"><i class="fa fa-save"></i> Save</button>
                        </form>
...
<script>
    ...
    $(function() {
        ...
        $("form[name='add_jenis_pekerjaan']").validate({
            ...
            messages: {
                jenis_kerja: {
                    required: "jenis pekerjaan is required (jenis pekerjaan harus di isi)",
                }
            },
